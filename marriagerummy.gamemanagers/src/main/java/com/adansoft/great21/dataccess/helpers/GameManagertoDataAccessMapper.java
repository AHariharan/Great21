...
public class GameManagertoDataAccessMapper {
	...
	public GameManagertoDataAccessMapper(String hostname, String port, String baseURL) {
		super();
	...
	public GameManagertoDataAccessMapper() {
		super();
