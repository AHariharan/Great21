...
/**
 * Home object for domain model class UserAudit.
 * @see com.adansoft.great21.dataaccess.home.UserAudit
 * @author Hibernate Tools
 */
public class UserAuditHome {

	private static final Log log = LogFactory.getLog(UserAuditHome.class);
	...
	public void persist(UserAudit transientInstance) {
		log.debug("persisting UserAudit instance");
		try {
	...
	public UserAudit merge(UserAudit detachedInstance) {
		...
		try {
			UserAudit result = (UserAudit) sessionFactory.getCurrentSession()
	...
	public UserAudit findById(java.lang.Long id) {
		log.debug("getting UserAudit instance with id: " + id);
		try {
			UserAudit instance = (UserAudit) sessionFactory.getCurrentSession()
					.get("com.adansoft.great21.dataaccess.home.UserAudit", id);
			if (instance == null) {
	...
	public List findByExample(UserAudit instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.adansoft.great21.dataaccess.home.UserAudit")
